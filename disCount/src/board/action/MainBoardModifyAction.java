...
public class MainBoardModifyAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// TODO Auto-generated method stub
		System.out.println("MainBoardModifyAction 시작");
		...
		try {
			...
			forward.setPath("./MainBoardDetailAction.bo?main_page_id=" + boarddata.getBoardid());
			return forward;
