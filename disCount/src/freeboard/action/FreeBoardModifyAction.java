...
public class FreeBoardModifyAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("FreeBoardModifyAction 시작");
		...
		String realFolder="";
		String saveFolder="/freeboardsrc";
		...
		if (usercheck == false) {
			...
			out.println("location.href='./BoardList.fr';");
			out.println("</script>");
			out.close();
			return null;
		}
		try {
			...
			forward.setPath("./FreeBoardDetailAction.fr?main_page_id=" + boarddata.getBoardid());
			return forward;
