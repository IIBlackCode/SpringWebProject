...
function board_delete() {
	location.href="MainBoardDeleteAction.bo?board_id=<%=board.getBoardid()%>";
	}
</script>
</head>
...
<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<td colspan="2" align="center">
			<%if(board.getFile()!=null){ %>
				<img id="blah"  src="./mainboardsrc/<%=board.getFile()%>" style="width: 300px;"/>
				<%} %>
		</td>
		</tr>
		...
		<tr align="center" valign="middle">
				<td colspan="5">
						...
						<a href="./MainBoardAction.bo">[목록]</a>&nbsp;&nbsp;
						<%if(board.getBoard_member_id().equals(session.getAttribute("id"))){ %>
						<a href="./MainBoardModifyView.bo?num=<%=board.getBoardid() %>">
						[수정]
						</a>&nbsp;&nbsp;																								
