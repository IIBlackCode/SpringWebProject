...
function board_delete() {
	location.href="QnABoardDeleteAction.qna?board_id=<%=board.getBoardid()%>";
	}
</script>
</head>
...
<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<td colspan="2" align="center">
			<%if(board.getFile()!=null){ %>
				<img id="blah"  src="./qnaboardsrc/<%=board.getFile()%>" style="width: 300px;"/>
				<%} %>
		</td>
		</tr>
		<tr bgcolor="cccccc">
		...
		<tr align="center" valign="middle">
				<td colspan="5">
						...
						<a href="./QnABoardAction.qna">[목록]</a>&nbsp;&nbsp;
						<%if(board.getBoard_member_id().equals(session.getAttribute("id"))){ %>
						<a href="./QnABoardModifyView.qna?num=<%=board.getBoardid() %>">
						[수정]
						</a>&nbsp;&nbsp;																								
...
<iframe src="ReplyView.bo?reply_type=qna&board_id=<%=request.getParameter("main_page_id") %>" 
